var lang = 0;
var ver = "v1.0.0.pstool_candidate.231117 (November 17, 2023)"
check()
function check(){
...
function seten() {
  ...
  exever.innerHTML = "Windows version (x64)"
  pstype.placeholder = "Type something to get started"
  ...
  dbv1.innerHTML = "1 (Doubled vowels) (default)"
  nctxt.innerHTML = "Replace digits 1-9 with circled digits (e.g. ①-⑨)"
  clear.innerHTML = "Clear"
  whattxt.innerHTML = "Pseudolocalization (or pseudo-localization) is a software testing method used for testing internationalization aspects of software. <br><br> The site is nearly in its final release. The tool is scheduled to be released in November 25, 2023."
  logtxt.innerHTML = "";
}
